...
description: "Case Study: Fertigungsunternehme digitalisiert 200+ Gschäftsprozäss mit XALT."
...
<section class="hero" style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div class="hc" style="max-width: 1100px; margin: 0 auto;">
    <div class="ht">
      ...
      <p style="font-size: 1.2rem; color: var(--mute); max-width: 650px; line-height: 1.7;">Fertigungsunternehme digitalisiert 200+ Gschäftsprozäss mit XALT.</p>
    </div>
  </div>
</section>

---
layout: base
title: "BSH Hausgeräte — XALT"
description: "Case Study: BSH Hausgeräte optimiert IT-Prozess mit XALT Jira-Lösung."
...
<section class="hero" style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div class="hc" style="max-width: 1100px; margin: 0 auto;">
    <div class="ht">
      ...
      <h1 style="font-size: 3rem; font-weight: 800; margin: 1rem 0;">BSH Hausgeräte</h1>
      <p style="font-size: 1.2rem; color: var(--mute); max-width: 650px; line-height: 1.7;">Case Study: BSH optimiert IT-Process mit XALT Jira-Lösung.</p>
    </div>
  </div>
</section>

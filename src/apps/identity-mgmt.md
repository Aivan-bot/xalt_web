---
layout: base
title: "Identity Management — XALT"
description: "Identity Management mit XLT's IAM solution."
category: "apps"
---
...
<section class="hero" style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div class="hc" style="max-width: 1100px; margin: 0 auto;">
    <div class="ht">
      ...
      <h1 style="font-size: 3rem; font-weight: 800; margin: 1rem 0;">Identity Management</h1>
      <p style="font-size: 1.2rem; color: var(--mute); max-width: 650px; line-height: 1.7;">Identity Management mit XLT's IAM-Lösig.</p>
    </div>
  </div>
</section>
...
<h2>IAM-Lösig für Ihre Atlassian-Landschaft</h2>
<p style="color: var(--mute); font-size: 1.05rem; line-height: 1.8; margin: 1.5rem 0;">
XLT's Identity Management-Lösig ermöglich zentrales Identity und Access Management in der gesamten Atlassian-Landschaft mit Single Sign-On und Multi-Factor Authentication.
</p>

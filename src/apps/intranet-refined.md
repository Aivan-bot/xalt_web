---
layout: base
title: "Intranet Refined — XALT"
description: "Refined intranet experience mit XALT's Confluence-based solution."
category: "apps"
---
...
<section class="hero" style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div class="hc" style="max-width: 1100px; margin: 0 auto;">
    <div class="ht">
      ...
      <h1 style="font-size: 3rem; font-weight: 800; margin: 1rem 0;">Intranet Refined</h1>
      <p style="font-size: 1.2rem; color: var(--mute); max-width: 650px; line-height: 1.7;">Modernes Intranet-Erlebnis uf Confluence-Basis mit XALT.</p>
    </div>
  </div>
</section>
...
<h2>Intranet Refined</h2>
<p style="color: var(--mute); font-size: 1.05rem; line-height: 1.8; margin: 1.5rem 0;">
XLT's Intranet Refined bietet es modernes Intranet-Erlebnis uf Confluence-Basis mit anpassbarer Navigation, Suchfunktion und Collaboration-Tools.
</p>

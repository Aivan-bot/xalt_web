---
layout: base
title: "Cookie-Richtlinie — XALT"
description: "Cookie-Information: Welche Cookies XALT verwendet und wie Sie diese verwalten können."
---

<section class="hero" style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div style="max-width: 1100px; margin: 0 auto; text-align: center;">
    <span class="htag" style="color: var(--primary); font-size: 0.9rem; letter-spacing: 3px;">LEGAL</span>
    <h1 style="font-size: 3rem; font-weight: 800; margin: 1rem 0;">Cookie-Richtlinie</h1>
  </div>
</section>

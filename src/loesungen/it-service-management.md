---
layout: base
title: "IT Service Management — XALT"
description: "XALT ITSM mit Atlassian Tools: Service Desk, Incident, Problem & Change Management."
category: "loesungen"
---
...
<section class="hero" style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div class="hc" style="max-width: 1100px; margin: 0 auto;">
    <div class="ht">
      ...
      <h1 style="font-size: 3rem; font-weight: 800; margin: 1rem 0;">IT Service Management</h1>
      <p style="font-size: 1.2rem; color: var(--mute); max-width: 650px; line-height: 1.7;">
ITSM mit Jira Service Management: Service Desk, Incident, Problem & Change Management us enrem Händ.
      </p>
    </div>
  </div>
</section>

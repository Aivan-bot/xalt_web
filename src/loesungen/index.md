...
<section style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div style="max-width: 1100px; margin: 0 auto; text-align: center;">
    ...
    <p style="color: var(--mute); font-size: 1.15rem; max-width: 800px; margin: 0 auto; line-height: 1.7;">Vo de Strategieschen Beratung über Cloud-Migration bis hin zu individuellen Apps: XLT bietet umfassende Lösungen für Ihre digitale Zukunft.</p>
  </div>
</section>
<section style="padding: 3rem 2rem;">
  <div style="max-width: 1100px; margin: 0 auto;">
    <div class="bgrid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
      ...
      <a href="/loesungen/cloud-migration/" style="text-decoration: none;"><div class="bcard" style="padding: 2rem; border-left: 4px solid var(--primary);"><h3>Cloud Migration</h3><p style="color: var(--mute);">Sicherer Umzug in d Cloud mit XLT Expertise.</p></div></a>

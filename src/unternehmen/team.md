...
<section class="hero" style="padding: 4rem 2rem; background: linear-gradient(135deg, var(--bg-surface), var(--bg-elevated));">
  <div style="max-width: 1100px; margin: 0 auto;">
    <div class="ht">
      ...
      <h1 style="font-size: 3rem; font-weight: 800; margin: 1rem 0;">Unser Team</h1>
      <p style="font-size: 1.25rem; color: var(--mute); max-width: 650px; line-height: 1.7;">XALT Team: Zertifizierata Atlassian-Experte mit über 15 jahre Erfahrung in de digitale Transformation.</p>
    </div>
  </div>
</section>
